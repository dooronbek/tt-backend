if (!vat) return res.status(400).json({ error: 'vat required' });require('dotenv').config();
const express = require('express');
coif (vat === undefined) return res.status(400).json({ error: 'vat required' });nst cors    = require('cors');
